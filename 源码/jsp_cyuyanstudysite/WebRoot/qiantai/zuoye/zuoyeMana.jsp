				...
				<TR>
					...
					<TD class=Side vAlign=top align=right width="75%">
									    ...
									    <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
											  ...
											  <tr align='center' bgcolor="#FFFFFF" height="22">
												  ...
												  <td><a href="#" onclick="down1('${zuoye.fujian}','${zuoye.fujianYuanshiming}')" style="font-size: 10px;color: red">down</a></td>
												   <td><a href="/cyuyanstudysite/zuoye?type=zuoyeDel&id=${zuoye.id}"  style="font-size: 10px;color: red">删除</a></td>
											  </tr>
											  </c:forEach>
				        			    </table>
									</TD>
						...
						<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
								...
								<TR align="left" height="200">
									<TD>
									    <form action="<%=path %>/zuoye?type=zuoyeAdd" name="form1" method="post">
									    <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
